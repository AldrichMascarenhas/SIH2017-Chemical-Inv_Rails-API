...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { logistic_id: @shipment.logistic_id } }, as: :json
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { logistic_id: @shipment.logistic_id } }, as: :json
    assert_response 200
  end
